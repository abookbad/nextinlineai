    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl rounded-2xl bg-white p-4 shadow-xl">
        <div className="aspect-video w-full overflow-hidden rounded-lg bg-black">
          {/* Placeholder for video/audio demo */}
          <iframe
            title="AI Demo"
        ...
        <div className="mt-3 text-right">
          <button
            onClick={() => setOpen(false)}
            className="rounded-full border border-black/10 bg-black/5 px-4 py-2 text-sm hover:bg-black/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
          >
            Close
          </button>
        </div>
